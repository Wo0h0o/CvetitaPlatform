...
- КРИТИЧНО ЗА JSON: ВЪТРЕ В стойностите на title и why НЕ ПОЛЗВАЙ ASCII double-quote символа и НЕ ползвай Bulgarian-quote двойки около имена на реклами/продукти. Ако трябва да цитираш име на ad/креатив, ползвай SINGLE quote, например 'ne e himiq'. Несъответстващо отваряне-затваряне (Bulgarian отваряне + ASCII затваряне) чупи JSON-а.
