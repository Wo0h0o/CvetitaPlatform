...
const PRESETS = [
  ...
  { key: "7d", label: "7 дни" },
  { key: "14d", label: "14 дни" },
  { key: "30d", label: "30 дни" },
  { key: "this_month", label: "Този месец" },
];
              ...
              {ov?.period?.start && (
                <div className="pt-3 border-t border-border">
                  <p className="text-[11px] text-text-3">
                    Период: {ov.period.start} — {ov.period.end}
                  </p>
                </div>
              )}
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`col-span-1 text-right text-[13px] font-semibold ${
                      c.roas >= 2 ? "text-accent" : c.roas >= 1 ? "text-text" : "text-red"
                    }`}>
  ...
  return (
    <div className={`flex items-center gap-3 p-3 rounded-lg ${highlight ? "bg-accent-soft" : "bg-surface-2"}`}>
      <div className={`w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0 ${
        highlight ? "bg-accent text-white" : "bg-surface"
      }`}>
        <Icon size={16} />
      </div>
