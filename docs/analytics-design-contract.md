...
- **Маркерите са точки — без снимки, без текст по тях.** Само позиция + размер + цвят (§10 marker дисциплина). Етикет директно на чарта получават само топ ~6 по тежест (magic-quadrant стил); останалите се идентифицират при hover или в списъка.
